...
from mass_mcp import __version__
...
def create_server() -> tuple[FastMCP, MusicAssistantClient]:
    ...
    All ``tools_*.py`` modules under ``mass_mcp.tools`` are imported and
